...
public class TestSolr {
    ...
    public void test01() throws IOException {
        ...
        //定义分词器   定义标准分词器 外国人开发 检索英文棒棒哒 检索中文效果不好
        ...
        //创建配置文件    定义版本号      表示对于版本控制要求严格  不能混用
         ...
         * 如果当前属性字段需要在页面展现 就写yes
         *
         * TextField与StringField的比较
         * TextField会将指定的value值进行索引词的重组  手机 移动 联通
         * StringField 会将整个value值当做索引词 不会拆分词组 不会进行粉刺操
         */
